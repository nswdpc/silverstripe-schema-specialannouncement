 ...
 * @property int $LinkID
 * @property int $NewsUpdatesAndGuidelinesID
 * @property int $DiseasePreventionInfoID
 * @property int $DiseaseSpreadStatisticsID
 * @property int $GettingTestedInfoID
 * @property int $GovernmentBenefitsInfoID
 * @property int $PublicTransportClosuresInfoID
 * @property int $QuarantineGuidelinesID
 * @property int $SchoolClosuresInfoID
 * @property int $TravelBansID
 * @method \SilverStripe\Assets\Image Image()
 * @method \gorriecoe\Link\Models\Link Link()
 * @method \gorriecoe\Link\Models\Link NewsUpdatesAndGuidelines()
 * @method \gorriecoe\Link\Models\Link DiseasePreventionInfo()
 * @method \gorriecoe\Link\Models\Link DiseaseSpreadStatistics()
 * @method \gorriecoe\Link\Models\Link GettingTestedInfo()
 * @method \gorriecoe\Link\Models\Link GovernmentBenefitsInfo()
 * @method \gorriecoe\Link\Models\Link PublicTransportClosuresInfo()
 * @method \gorriecoe\Link\Models\Link QuarantineGuidelines()
 * @method \gorriecoe\Link\Models\Link SchoolClosuresInfo()
 * @method \gorriecoe\Link\Models\Link TravelBans()
 * @method \SilverStripe\ORM\ManyManyList<\Page> Pages()
 */
class SpecialAnnouncement extends DataObject implements PermissionProvider, TemplateGlobalProvider
{
        ...
        $fields->addFieldsToTab(
            ...
            [
                TextField::create(
                    ...
                    _t(
                        self::class . '.TITLE_DESCRIPTION',
                        'Provide a short, one-line, description of the announcement.'
                    )
                )->setRightTitle(
                    _t(
                        self::class . '.TITLE_RIGHT',
                        "Schema.org entry:'name'"
                    )
                ),
                CheckboxField::create(
                    'IsGlobal',
                    _t(self::class . ".TITLE", "Site-wide announcement")
                )->setDescription(
                    _t(
                        self::class . '.ISGLOBAL_DESCRIPTION',
                ...
                ->setRightTitle(
                    ...
                    _t(
                        self::class . '.DEFAULT_CATEGORY_DESCRIPTION',
                ...
                TextareaField::create(
                    'ShortDescription',
                    _t(self::class . ".SHORT_DESCRIPTION", "Short description")
                )
                ->setRows(3)
                ->setDescription(
                    _t(
                        self::class . '.SHORT_DESCRIPTION_DESCRIPTION',
                ...
                HTMLEditorField::create(
                    ...
                    _t(
                        self::class . '.CONTENT_DESCRIPTION',
                    ...
                    _t(
                        self::class . '.CONTENT_RIGHT',
                        'This value is not used in Schema.org markup'
                    )
                ),
                DatetimeField::create(
                    'DatePosted',
                    _t(self::class . ".DATE_POSTED", "Date posted")
                )->setDescription(
                    _t(
                        self::class . '.DATE_POSTED_DESCRIPTION',
                        'This is the date that the announcement was published. It should be in the past.'
                    )
                )->setRightTitle(
                    _t(
                        self::class . '.DATE_POSTED_RIGHT',
                        "Schema.org entry:'datePosted'"
                    )
                ),
                DatetimeField::create(
                    'Expires',
                    _t(self::class . ".EXPIRES", "Expires")
                )->setDescription(
                    _t(
                        self::class . '.EXPIRES_DESCRIPTION',
    ...
    public function getLinkDescriptions(): array
    {
        return [
            ...
            'NewsUpdatesAndGuidelines' => _t(self::class . '.NewsUpdatesAndGuidelines_INFO', 'A page with news updates and guidelines in the context of announcement, if applicable to the announcement. This could be (but is not required to be) the main page containing SpecialAnnouncement markup on a site.'),

            'DiseasePreventionInfo' =>  _t(self::class . '.DiseasePreventionInfo_INFO', 'Information about disease prevention, if applicable to the announcement.'),

            'DiseaseSpreadStatistics' => _t(self::class . '.DiseasePreventionInfo_INFO', 'If applicable to the announcement, a link to the statistical information about the spread of a disease.'),

            'GettingTestedInfo' => _t(self::class . '.GettingTestedInfo_INFO', 'A link to information about getting tested (for a MedicalCondition) in the context of COVID-19, if applicable to the announcement.'),

            'GovernmentBenefitsInfo' => _t(self::class . '.GovernmentBenefitsInfo_INFO', 'A link to information about new government benefits in the context of COVID-19, if applicable to the announcement'),

            'PublicTransportClosuresInfo' => _t(self::class . '.PublicTransportClosuresInfo_INFO', 'A link to information about public transport closures in the context of COVID-19, if applicable to the announcement'),

            'QuarantineGuidelines' => _t(self::class . '.QuarantineGuidelines_INFO', 'A link to guidelines about quarantine rules in the context of COVID-19, if applicable to the announcement.'),

            'SchoolClosuresInfo' => _t(self::class . '.SchoolClosuresInfo_INFO', 'A link to information about school closures in the context of COVID-19, if applicable to the announcement.'),
     ...
     * @return mixed[]
     */
    public static function get_schema_json(self $record): array
    {
        $schema = [
